...
public class ChooseTypeAdapter extends MyAdapter {
    List<ItemListConditionBean.DataBean.WorkTypeBean> list;
    Context context;

    public ChooseTypeAdapter(List<ItemListConditionBean.DataBean.WorkTypeBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ItemListConditionBean.DataBean.WorkTypeBean item = list.get(position);
