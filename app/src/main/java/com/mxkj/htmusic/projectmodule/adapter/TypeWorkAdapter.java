...
public class TypeWorkAdapter extends MyAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHorder vh = null;
        if(convertView==null){
            convertView = LayoutInflater.from(context).inflate(R.layout.typework_item,null);
            vh = new ViewHorder();
            vh.projectdetails_lyrics= (TextView) convertView.findViewById(R.id.projectdetails_lyrics);
            vh.projectdetails_money= (TextView) convertView.findViewById(R.id.projectdetails_money);
            convertView.setTag(vh);
        }
        vh= (ViewHorder) convertView.getTag();
        final TypeWorkBean.DataBean item = list.get(position);

        vh.projectdetails_lyrics.setText(item.getTitle());
        vh.projectdetails_money.setText(item.getContent());
