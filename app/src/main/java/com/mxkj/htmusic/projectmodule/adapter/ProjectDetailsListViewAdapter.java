...
public class ProjectDetailsListViewAdapter extends MyAdapter {
    List<ProjectDetailsBean.DataBean.TaskBean> list;
    Context context;
    ...
    public ProjectDetailsListViewAdapter(List<ProjectDetailsBean.DataBean.TaskBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHorder vh = null;
        if(convertView==null){
            convertView = LayoutInflater.from(context).inflate(R.layout.projectdetailslistview_item,null);
            vh = new ViewHorder();
        ...
        final ProjectDetailsBean.DataBean.TaskBean item = list.get(position);

        vh.projectdetails_lyrics.setText(item.getWork_type_title());
