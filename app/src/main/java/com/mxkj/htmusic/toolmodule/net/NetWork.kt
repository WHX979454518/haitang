...
object NetWork {
     ...
     */
    fun getCom(context: Context, callBack: TokenCallBack) {
        getSecretRequest(false, "get", context, ApiAddress.GET_TOKEN, null, callBack)
    }
     ...
     * reg注册,login登录,find找回密码，pwd修改密码，unbind解除绑定，sms快速登录/绑定
     */
    fun getCode(area_code: String?, type: String?, byWhat: String?, mobile: String?, context: Context, callBack: TokenCallBack) {
...
//        }
        ...
        getSecretRequest(false, "post", context, ApiAddress.GET_CODE, params, callBack)
    }

    /**
     * 快速登录
     */
    fun getfastlogin(mobile: String?,area_code: String?, code: String?,  context: Context, callBack: TokenCallBack) {
        val params = HttpParams()
        if (!TextUtils.isEmpty(mobile)) {
            params.put("mobile", mobile)
        }
        ...
        Log.e(TAG, "getfastlogin: $params")
        getSecretRequest(false, "post", context, ApiAddress.FAST_LOGIN, params, callBack)
    }
    /**
     * 获取用户信息
     */
     ...
     * 快速登录设置密码
     */
    fun getfastsetpassword(key: String?,password: String?,context: Context, callBack: TokenCallBack) {
        val params = HttpParams()
        ...
        Log.e(TAG, "getfastsetpassword: $params")
        getSecretRequest(false, "post", context, ApiAddress.FAST_SET_PASSWORD, params, callBack)
    }
    /**
     * 账号密码登录
     */
    fun getPwdLogin(context: Context, login_name: String, password: String,callBack: TokenCallBack) {
        val params = HttpParams()
...
//        params.put("device_finger", registrationId)
        Log.e(TAG, "getPwdLogin==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_PWD_LOGIN, params, callBack)
    }
    /**
     * 首页项目列表
     */
    fun getprojectIndex(context: Context, min_budget: String, max_budget: String, work_type_id: String, keyword: String,order: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("min_budget", min_budget)
        params.put("max_budget", max_budget)
        params.put("work_type_id", work_type_id)
        params.put("keyword", keyword)
        params.put("order", order)
        Log.e(TAG, "getprojectIndex==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_PROJECT_INDEX, params, callBack)
    }

    /**
     * 项目列表条件
     */
    fun getprojectCondition(context: Context,callBack: TokenCallBack) {
        val params = HttpParams()
        Log.e(TAG, "getprojectCondition==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_PROJECT_CONDITION, params, callBack)
    }
    /**
     * 项目详情
     */
    fun getprojectInfo(context: Context, id: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id", id)
        Log.e(TAG, "getprojectIndex==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_PROJECT_INFO, params, callBack)
    }
    /**
     * 获取任务简介
     */
    fun getprojecttaskInfo(context: Context, task_id: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("task_id", task_id)
        Log.e(TAG, "getprojecttaskInfo==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_PROJECT_TASK_INFO, params, callBack)
    }
    /**
     * 收藏项目
     */
    fun getprojectcollection(context: Context,id: String,callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "getprojectcollection==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_PROJECT_COLLECT, params, callBack)
    }
    /**
     * 取消收藏项目
     */
    fun getprojectuncollection(context: Context,id: String,callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "getprojectcollection==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_PROJECT_UN_COLLECT, params, callBack)
    }
     ...
     * 音乐人项目报名
     */
    fun getprojectunenroll(context: Context,
                           enroll:String,
                           callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("enroll",enroll)
        Log.e(TAG, "getprojectunenroll==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_PROJECT_ENROLL, params, callBack)
    }
     ...
     * 发布项目
     */
    fun getaddprojecTaskt(context: Context, uid: Int,
                          project_title: String,
                          work_use_ids: String,
                          use_channel_ids: String,
                          project_desc: String,
                          secrecy_days: String,
                          work_style_ids: String,
                          project_status: Int,
                          min_budget: Float,
                          max_budget: Float,
                          task: String,
        ...
        params.put("work_use_ids",work_use_ids)
        params.put("use_channel_ids",use_channel_ids)
        params.put("project_desc",project_desc)
        params.put("secrecy_days",secrecy_days)
        params.put("work_style_ids",work_style_ids)
        params.put("project_status",project_status)
        params.put("min_budget",min_budget)
        params.put("max_budget",max_budget)
        params.put("task", task.toString())
     ...
     * 作品分格
     */
    fun getworkstyle(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "getworkstyle==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_WORK_STYTLE, params, callBack)
    }
    /**
     * 获取作品用途(使用范围)
     */
    fun getusescope(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "getworkstyle==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_USE_SCOPE, params, callBack)
    }
    /**
     * 获取使用渠道
     */
    fun getusechannel(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "getusechannel==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_USE_CHANNEL, params, callBack)
    }
     ...
     * 获取工种类型
     */
    fun getworktype(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id",id)
        Log.e(TAG, "params==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_WORK_TYPE, params, callBack)
    }

    /**
     * 获取项目的所有任务/工种
     */
    fun getalltask(context: Context, project_id: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("project_id",project_id)
        Log.e(TAG, "getalltask==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_ALL_TASK, params, callBack)
    }
     ...
     * 获取应征列表之报名音乐人列表
     */
    fun getenroollist(context: Context, status: String,order: String ,work_type_id: String, project_id: Int,  callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("status", status)
        params.put("order", order)
        params.put("work_type_id", work_type_id)
        params.put("project_id",project_id)
        Log.e(TAG, "getenroollist==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_ENROOL, params, callBack)
       }
     ...
     * 获取应征列表之选定音乐人列表
     */
    fun getcontractlist(context: Context, require_status: String ,work_type_id: String, order: String, project_id: Int,  callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("require_status", require_status)
        params.put("work_type_id", work_type_id)
        params.put("order",order)
        params.put("project_id",project_id)
        Log.e(TAG, "getcontractlist==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_CONREACT, params, callBack)
    }
     ...
     * 招募人发送合同
     */
    fun getconreact(context: Context,
                    project_id: Int,
                    project_task_id: Int,
                    work_type_id: Int,
                    enroll_id: Int,
        ...
        val params = HttpParams()
        params.put("project_id", project_id)
        params.put("project_task_id", project_task_id)
        params.put("work_type_id", work_type_id)
        params.put("enroll_id",enroll_id)
        params.put("uid",uid)
        params.put("musician_id",musician_id)
        params.put("money",money)
        params.put("creation_days",creation_days)
        params.put("content",content)
        Log.e(TAG, "getconreact==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_CONTRACT, params, callBack)
    }

    /**
     * 获取指定合同信息
     */
    fun getcontract(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
//        params.put("id", id)
        Log.e(TAG, "getcontract==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_CONTRACTTEXT+"/$id", params, callBack)
      }
    /**
     * 获取合作状态纪录
     */
    fun getcontractlog(context: Context, project_id: Int,project_task_id: Int,uid: Int,musician_id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("project_id", project_id)
        params.put("project_task_id", project_task_id)
        params.put("uid", uid)
        params.put("musician_id", musician_id)
        Log.e(TAG, "getcontractlog==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_CONTRACT_LOG, params, callBack)
    }

    /**
     * 招募人获取 '我的项目' 列表
     */
    fun getproject(context: Context, project_status: String,order: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("project_status", project_status)
        params.put("order", order)
        Log.e(TAG, "getproject==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_PROJECT, params, callBack)
    }
     ...
     * 音乐人获取'我参与的' 项目列表
     */
    fun getmusicancontract(context: Context, musician_status: String,order: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("musician_status", musician_status)
        params.put("order", order)
        Log.e(TAG, "getmusicancontract==: $params")
        getSecretRequest(false, "get", context, ApiAddress.GET_MUSICAN_CONTRACT, params, callBack)
    }

    /**
     * 音乐人拒绝签约
     */
    fun getrejectsign(context: Context, id: Int,reason: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id", id)
        params.put("reason", reason )
        Log.e(TAG, "getrejectsign==: $params")
        getSecretRequest(false, "put", context, ApiAddress.GET_REJECT_SIGN, params, callBack)
    }

    /**
     * 音乐人同意签约
     */
    fun getagreesign(context: Context, id: Int, callBack: TokenCallBack) {
        val params = HttpParams()
//        params.put("id", id)
        Log.e(TAG, "getagreesign==: $params")
        getSecretRequest(false, "put", context, ApiAddress.GET_AGREE_SIGN+"/$id", params, callBack)
    }

    /**
     * 音乐人申请终止项目合同
     */
    fun getapplestop(context: Context, id: Int,reason: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id", id)
        params.put("reason", reason)
        Log.e(TAG, "getapplestop==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_APPLY_STOP, params, callBack)
    }

    /**
     * 音乐人申请延长项目合同周期
     */
    fun getappledelay(context: Context, contract_id: Int,delay_days :Int,reason: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("contract_id", contract_id)
        params.put("delay_days", delay_days)
        params.put("reason", reason)
        Log.e(TAG, "getappledelay==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_APPLY_DELAY, params, callBack)
    }
     ...
     * 招募人取消签约
     */
    fun getcancelsign(context: Context, id: Int,reason: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("id", id)
        params.put("reason", reason )
        Log.e(TAG, "getcancelsign==: $params")
        getSecretRequest(false, "put", context, ApiAddress.GET_CANCEL_SIGN, params, callBack)
    }

    /**
     * 招募人快速验收
     */
    fun getfastcheck(context: Context, uid: Int,project_id: Int,project_task_id: Int,contract_id: Int,callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("uid", uid)
        params.put("project_id", project_id)
        params.put("project_task_id", project_task_id)
        params.put("contract_id", contract_id)
        Log.e(TAG, "getfastcheck==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_FAST_CHECK, params, callBack)
    }

    /**
     * 招募人延长项目合同周期
     */
    fun getdelay(context: Context, contract_id: Int,delay_days: Int, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("contract_id", contract_id)
        params.put("delay_days", delay_days)
        Log.e(TAG, "getdelay==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_DELAY, params, callBack)
    }

    /**
     * 招募人终止合作
     */
    fun getcontract(context: Context, contract_id: Int,is_stop_reason: String, callBack: TokenCallBack) {
        val params = HttpParams()
        params.put("contract_id", contract_id)
        params.put("is_stop_reason", is_stop_reason)
        Log.e(TAG, "getcontract==: $params")
        getSecretRequest(false, "post", context, ApiAddress.GET_CONRACT_STOP, params, callBack)
    }

    /**
     * 合作完成相互评价
     */
    fun getevaluate(context: Context,
                    uid: Int,
                    to_uid: Int,
                    project_id: Int,
                    project_task_id: Int,
        ...
        Log.e(TAG, "getevaluate==: $params")
        if(identity_type == 1){
            params.put("work_quality", work_quality)
            params.put("punctual", punctual)
        }else{
            params.put("description", description)
            params.put("inspect_punctual", inspect_punctual)
        }
     ...
     * 招募人支付
     */
    fun getcreateorder(context: Context,
                       project_id: Int,
                       project_task_id: Int,
                       contract_id: Int,
                       uid: Int,
...
//        params.put("user_coupon_id", user_coupon_id )
        ...
        getSecretRequest(false, "post", context, ApiAddress.GET_CREATE_ORDER, params, callBack)
    }


    fun getcreateorder(context: Context, params: HttpParams?, tokenCallBack: TokenCallBack) {
        Log.e(TAG, "getcreateorder==: $params")
     ...
     * 获取应征列
     */
    fun getenrot(context: Context, musician_status: Int, row: Int, order: String, callBack: TokenCallBack) {
        val params = HttpParams()
//        params.put("p", page.toString())
        getSecretRequest(false, "get", context, "/get-musician-contract?musician_status/$musician_status/order/$order", params, callBack)
    }
