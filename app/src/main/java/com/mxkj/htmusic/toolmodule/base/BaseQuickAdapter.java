...
import com.mxkj.htmusic.toolmodule.base.animation.AlphaInAnimation;
import com.mxkj.htmusic.toolmodule.base.animation.BaseAnimation;
import com.mxkj.htmusic.toolmodule.base.animation.ScaleInAnimation;
import com.mxkj.htmusic.toolmodule.base.animation.SlideInBottomAnimation;
import com.mxkj.htmusic.toolmodule.base.animation.SlideInLeftAnimation;
import com.mxkj.htmusic.toolmodule.base.animation.SlideInRightAnimation;
import com.mxkj.htmusic.toolmodule.base.entity.IExpandable;
import com.mxkj.htmusic.toolmodule.base.loadmore.LoadMoreView;
import com.mxkj.htmusic.toolmodule.base.loadmore.SimpleLoadMoreView;
...
//        openLoadMore(requestLoadMoreListener);cao!！
    }


    /**
     * uncheck if full page after {@link #setNewData(List)}, if full, it will enable load more again.
     *
...
//        if (mRecyclerView != null && (mRecyclerView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE || (mRecyclerView.isComputingLayout() == false))) {
