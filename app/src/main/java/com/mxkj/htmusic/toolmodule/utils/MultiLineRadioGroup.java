...
public class MultiLineRadioGroup extends ViewGroup implements OnClickListener {
    ...
    public MultiLineRadioGroup(@NonNull Context context, AttributeSet attrs,
                               int defStyleAttr) {
    ...
    public MultiLineRadioGroup(@NonNull Context context) {
        this(context, null, 0);
    }
    ...
    public void addAll(@Nullable List<String> list) {
