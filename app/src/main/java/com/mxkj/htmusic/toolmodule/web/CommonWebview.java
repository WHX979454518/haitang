//package com.mxkj.haitang.toolmodule.web;
//
...
//import com.mxkj.haitang.toolmodule.base.bean.UserInfo;
...
//    public UserInfo.DataBean.MusicBean musicBean;
...
//            showRightButton();
//            Button("提交", null, new View.OnClickListener() {
//                @Override
...
//            Button("", drawable, new View.OnClickListener() {
//                @Override
//                public void onClick(View view) {
//                    showDialog = false;
//                    if (musicBean == null) {
