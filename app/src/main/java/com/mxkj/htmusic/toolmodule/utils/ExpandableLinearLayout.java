...
public class ExpandableLinearLayout extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = ta.getColor(R.styleable.ExpandableLinearLayout_tipTextColor, Color.parseColor("#a1aab3"));
    ...
    private void expand() {
        for (int i = defaultItemCount; i < getChildCount(); i++) {
            ...
            img_tips.setImageResource(R.mipmap.icon_content_shouqi);
    ...
    private void hide() {
        ...
        for (int i = defaultItemCount; i < endIndex; i++) {
            ...
            img_tips.setImageResource(R.mipmap.icon_content_zhankai);
