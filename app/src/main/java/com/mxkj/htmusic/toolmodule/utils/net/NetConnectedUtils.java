package com.mxkj.htmusic.toolmodule.utils.net;
...
//        networkInfo.isConnected();
     ...
     */
    public static boolean isPhoneNetConnected(@NonNull Context context) {
     ...
     */
    public static boolean isWifiNetConnected(@NonNull Context context) {
     ...
     */
    private static boolean isNetworkConnected(@NonNull Context context, int typeMobile) {
        boolean ret = false;
        //判断是否有网络
