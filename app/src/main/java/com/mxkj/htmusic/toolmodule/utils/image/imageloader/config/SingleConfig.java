package com.mxkj.htmusic.toolmodule.utils.image.imageloader.config;
...
import com.mxkj.htmusic.toolmodule.utils.image.imageloader.utils.ImageUtil;
...
public class SingleConfig {
    ...
    private boolean isGif = true; //是否是GIF图
    private View target;
    private int width;
    private int height;
    private int oWidth;
    ...
    public SingleConfig(ConfigBuilder builder) {
        ...
        this.getWidth = builder.getWidth;
        this.getHeight = builder.getHeight;
    ...
    public static class ConfigBuilder {
        ...
        private int getWidth, getHeight, format;
         ...
         * @return
         */
        public ConfigBuilder url(String u) {
            if(u == null || u.equals("")){
                return this;
            }else {
                if (u.isEmpty()) {
...
//       TODO 旧版glide会加载webp失败.format=0为之压缩，为1时压缩为webp（有些有需要的地方单独处理了图片链接，所以为了兼容大多数场景，这里默认为0。）
            url="";
            if (this.getWidth > 0) {
                url = url + "w=" + this.getWidth+"&";
            }
            if (this.getHeight > 0) {
                url = url + "h=" + this.getHeight+"&";;
            }
            url = url + "limit=0";
            if (!u.contains("?")) {
                u = u + "?";
            ...
            url=u+url;
            if (StringUtils.isEmpty(url).contains("gif")) {
                isGif = true;
            }
        ...
        public ConfigBuilder format(int format) {
            this.format = format;
            return this;
        }
        ...
        /**
         * 2.6新增 处理图片自动裁剪
         * @param imgpicInfoBean
         * @return
         */
//        public ConfigBuilder setUrl(HomeBean.ImgpicInfoBean imgpicInfoBean) {
//            if (imgpicInfoBean == null) {
//                return this;
//            }
//            if(imgpicInfoBean.getLink().isEmpty()){
//                return  this;
//            }
//            String params="";
//            if (this.getWidth > 0) {
//                params = params + "w=" + this.getWidth+"&";
//            }
//            if (this.getHeight > 0) {
//                params = params + "h=" + this.getHeight+"&";;
//            }
//            if (imgpicInfoBean.getLink().contains("?")) {
//                url = imgpicInfoBean.getLink();
//            } else {
//                url = imgpicInfoBean.getLink() + "?";
//            }
//            url = url +params+ "limit=0";
//            if (imgpicInfoBean.getExt().isEmpty()&&imgpicInfoBean.getExt().equals("gif")) {
//                isGif = true;
//            }
//            return this;
//        }
        ...
        public ConfigBuilder getSize(int oWidth, int oHeight) {
            this.getWidth = oWidth;
            this.getHeight = oHeight;
            return this;
        }
