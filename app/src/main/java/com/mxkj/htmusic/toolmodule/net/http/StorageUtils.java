...
//            String cacheDirPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/yytcache/";
...
//        File dataDir = new File(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/yytcache/","Android"), "data");
