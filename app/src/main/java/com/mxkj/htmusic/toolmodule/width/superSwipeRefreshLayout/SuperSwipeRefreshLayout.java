package com.mxkj.htmusic.toolmodule.width.superSwipeRefreshLayout;
...
public class SuperSwipeRefreshLayout extends ViewGroup implements NestedScrollingChild {
    ...
    public AddViewType getViewType() {
        if (null == viewType) {
            return AddViewType.HEAD_AND_FOOTER;
        }
        return viewType;
    }

    public void setViewType(AddViewType viewType) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs((int) ev.getRawY() - downY) < Math.abs(moveX - downX)) {
                    return false;
                }
